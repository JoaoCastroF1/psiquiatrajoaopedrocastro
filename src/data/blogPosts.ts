...
export const blogPosts: BlogPost[] = [
  {
    ...
    metaDescription:
      "Atendimento particular com reembolso pelo plano de saúde. Nota fiscal, documentação, prazos e regras de Unimed, Bradesco, Amil, SulAmérica, IPSEMG, Cassi e outros.",
    excerpt:
      "Atendimento particular não significa pagar tudo do bolso. A maior parte dos planos reembolsa, e a documentação central é a nota fiscal eletrônica. Como pedir, o que cada plano exige, o que evita a glosa e como usar o gasto na declaração do imposto de renda.",
    date: "06 Mai 2026",
    ...
    content: [
      ...
      "Como a parte da declaração do imposto de renda tem regras específicas que merecem detalhamento próprio (DMED, Carnê-Leão para profissionais autônomos pagadores, declaração de dependentes, conjugais separadas e em conjunto, dedução em casos de coparticipação), escrevi um post separado sobre o tema. Para detalhes sobre como usar a nota fiscal da consulta psiquiátrica na declaração do imposto de renda, vale ler [Nota fiscal do psiquiatra para restituição do IRPF](/blog/nota-fiscal-psiquiatra-restituicao-irpf).",
  ...
  },
  {
    ...
    metaDescription:
      "Despesas com psiquiatra são dedutíveis sem teto na declaração completa. Como usar nota fiscal e Receita Saúde, descontar reembolso do plano e evitar malha fina.",
    excerpt:
      "Tratamento psiquiátrico particular é uma das despesas mais bem tratadas pela legislação tributária brasileira. Como declarar, o que descontar do reembolso, e quanto isso muda no custo efetivo do tratamento.",
    date: "06 Mai 2026",
  ...
  },
  {
    ...
    metaDescription:
      "Sertralina é o ISRS mais prescrito no Brasil. Dose-resposta linear, primeira escolha em TOC e TEPT, segurança em gravidez. Como ela age e o que esperar.",
    excerpt:
      "Por que a sertralina segue como primeira escolha em vários cenários, como funciona o perfil dose-resposta dela, em que indicações ela se destaca dos demais ISRS e o que esperar das primeiras semanas de tratamento.",
    date: "06 Mai 2026",
    readTime: "7 min de leitura",
    keywords: [
      "sertralina",
  ...
  },
  {
    ...
    metaDescription:
      "Venlafaxina age como ISRS em doses baixas e como ISRN em doses altas. Indicada em depressão refratária e TAG, exige cuidado com pressão arterial e descontinuação.",
    excerpt:
      "Por que o efeito clínico da venlafaxina muda conforme a dose, em que cenários ela é primeira escolha, o que vigiar na pressão arterial e por que a descontinuação é o capítulo mais complicado da medicação.",
    date: "06 Mai 2026",
    readTime: "7 min de leitura",
    keywords: [
      "venlafaxina",
  ...
  },
  {
    ...
    metaDescription:
      "Lítio é o único psicofármaco com efeito antissuicida específico documentado. Janela terapêutica estreita, monitoramento renal e tireoidiano, decisão na gravidez.",
    excerpt:
      "O lítio é o medicamento psiquiátrico mais antigo em uso de primeira linha. Por que ele segue sendo escolha em transtorno bipolar tipo I, qual a propriedade clínica que outras medicações não reproduzem, e como funciona o monitoramento que sustenta o tratamento a longo prazo.",
    date: "06 Mai 2026",
    readTime: "8 min de leitura",
    keywords: [
      "lítio",
  ...
  },
  {
    ...
    metaDescription:
      "Alprazolam tem meia-vida curta, alta tolerância e dependência. Indicado em pânico agudo por curtos períodos. Como descontinuar e por que o uso crônico no Brasil é problema clínico.",
    excerpt:
      "Por que o perfil farmacocinético do alprazolam o torna particularmente difícil de descontinuar, em quais situações ele ainda faz sentido clinicamente e por que o uso crônico disseminado no Brasil é um problema de saúde pública.",
    date: "06 Mai 2026",
    readTime: "7 min de leitura",
    keywords: [
      "alprazolam",
  ...
  },
  {
    ...
    metaDescription:
      "Melatonina é cronobiótico, não hipnótico. Funciona em jet lag, fase atrasada do sono e insônia em idoso. Para insônia primária do adulto, evidência é fraca.",
    excerpt:
      "Por que a melatonina é cronobiótico e não hipnótico, em que indicações ela tem evidência sólida e em quais o uso popular não corresponde ao que a literatura mostra. Dose, horário e a diferença entre liberação rápida e prolongada.",
    date: "06 Mai 2026",
    readTime: "7 min de leitura",
    keywords: [
      "melatonina",
  ...
  },
  {
    ...
    content: [
      ...
      "Antidepressivos não funcionam como analgésicos. Não aliviam sintomas em minutos ou horas. O mecanismo de ação envolve mudanças graduais na neurotransmissão, com aumento da disponibilidade de serotonina, noradrenalina ou dopamina nas sinapses, que desencadeiam adaptações cerebrais ao longo de semanas.",
      ...
      "Se após 4 a 6 semanas na dose adequada não houver resposta significativa, o psiquiatra considera ajuste de dose, troca de medicamento ou associação com outro fármaco. Manter por meses um antidepressivo que não está funcionando é inércia terapêutica.",
