    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between h-16 md:h-20">
        <div className="flex flex-col">
          ...
          <span className="hidden md:block whitespace-nowrap font-body text-[10px] uppercase tracking-[0.15em] text-foreground/70 mt-0.5">
            Psiquiatra · Psicogeriatra · CRM-MG 83920
          </span>
          <span className="md:hidden whitespace-nowrap font-body text-[9px] uppercase tracking-[0.12em] text-foreground/70 mt-0.5">
