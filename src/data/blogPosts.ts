...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    readTime: "7 min de leitura",
    content: [
      "Procurar um psiquiatra ainda carrega um peso simbólico que não deveria existir. Parte desse peso vem de uma confusão frequente: a ideia de que psiquiatra é para quem 'enlouqueceu'. Na prática, a maior parte dos pacientes que chegam ao consultório apresenta quadros que qualquer pessoa pode desenvolver ao longo da vida: ansiedade persistente, insônia crônica, episódios depressivos, dificuldade de concentração ou crises de pânico.",
      "Existem sinais claros de que uma avaliação psiquiátrica é indicada. O primeiro é a persistência: quando um sintoma emocional ou comportamental dura semanas e não melhora com mudanças no estilo de vida. Tristeza que não passa, irritabilidade constante, medo desproporcional ou pensamentos repetitivos que atrapalham o dia a dia são exemplos concretos.",
      "O segundo sinal é o prejuízo funcional. Quando o sono está consistentemente ruim, o trabalho começa a ser afetado, os relacionamentos deterioram ou a pessoa deixa de fazer coisas que antes fazia com naturalidade, há um padrão que merece investigação clínica.",
      "O terceiro sinal é a recorrência. Episódios que vão e voltam — crises de ansiedade, fases de desânimo profundo, períodos de insônia seguidos de hipersonia — sugerem que existe um transtorno de base que precisa de diagnóstico e tratamento estruturado, não apenas manejo pontual.",
      "Em Belo Horizonte, o atendimento psiquiátrico particular funciona de forma diferente do que muitos imaginam. A primeira consulta é uma avaliação ampla, com duração de aproximadamente uma hora, que inclui história clínica detalhada, revisão de tratamentos anteriores, análise do contexto de vida e, quando necessário, solicitação de exames laboratoriais para descartar causas orgânicas.",
      "Um ponto que diferencia o atendimento psiquiátrico de qualidade é a investigação diagnóstica. Antes de prescrever qualquer medicamento, o psiquiatra precisa entender o que está acontecendo. Ansiedade pode ser sintoma de hipertireoidismo. Fadiga pode ser anemia. Dificuldade de concentração pode ser TDAH, depressão ou privação crônica de sono. Cada hipótese exige uma abordagem diferente.",
      "O consultório fica na região da Savassi/Lourdes, com acesso fácil para quem vem do centro ou de bairros como Funcionários, Santo Agostinho e Serra. O atendimento também está disponível por telemedicina para pacientes que preferem essa modalidade ou que residem fora de Belo Horizonte.",
      "Se você reconhece algum dos sinais descritos neste artigo, considere agendar uma avaliação. O objetivo da primeira consulta não é necessariamente iniciar medicação. É entender o que está acontecendo e, a partir disso, definir o caminho mais adequado para o seu caso.",
    ],
  },
  {
